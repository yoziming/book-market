...
public class BookDaoTest {
    ...
    @Test
    public void addBook() {
        bookDao.addBook(new Book(null,"國哥為什麼這麼帥！", "191125", new BigDecimal(9999),1100000,0,null
                ));
    }
    ...
    public void updateBook() {
        bookDao.updateBook(new Book(21,"大家都可以這麼帥！", "國哥", new BigDecimal(9999),1100000,0,null
        ));
    }
