    ...
    <table>
        ...
        <c:forEach items="${requestScope.page.items}" var="book">
            <tr>
                ...
                <td>${book.sales}</td>
                <td>${book.stock}</td>
                <td><a href="BookServlet?action=getBook&id=${book.id}&pageNo=${requestScope.page.pageNo}">修改
                </a></td>
                <td><a class="deleteClass"
                       href="BookServlet?action=delete&id=${book.id}&pageNo=${requestScope.page.pageNo}">刪除</a></td>
            </tr>
        </c:forEach>
        <tr>
            <td></td>
